...
## 🔍 Important Note
Deep Research is **not** yet available for most users. To request access, please [contact us](https://rogo.mintlify.app/about/contact-us).
...
A good example is anytime you’re asking Rogo to find a certain data point for a list of things satisfying some condition, where it’s not immediately obvious which things and which things won’t. For instance, below we ask Rogo to find revenue and number of stores opened for Starbucks and McDonald’s in the cities where Starbucks has opened the most stores recently.

In normal search, this wouldn’t work, because Rogo first needs to find the right cities and then find the relevant metrics for those cities. But Deep Research can handle this sort of complex, multi-step question, which is closer to emulating work you'd give a smart analyst or intern.

## 🧑‍🔬 How To Use it
1. Start by clicking “Research”
...
2. Then enter your research question
...
3. Read through Rogo’s plan and tell it to proceed
